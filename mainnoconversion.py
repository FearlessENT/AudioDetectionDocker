...
def process_video(video_file, model_file, output_directory=None, buffer_before=2, buffer_after=4, convert = True, pass_number = 1):
    ...
    if pass_number == 2:
        # Trim the video
        output_file_path = trim_video(video_file, segments, output_directory, pass_number = 2)
    else:
        # Trim the video
